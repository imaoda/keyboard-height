...
var KeyboardObserver = /*#__PURE__*/function () {
  function KeyboardObserver() {
    ...
    this.cbArr_ = [];
    if (_uitls.isAndroid) (0, _android.default)(this.cbArr_);else if (_uitls.isIos) (0, _ios.default)(this.cbArr_);
  }
  ...
  _createClass(KeyboardObserver, [{
    ...
    value: function getHeight() {
      if (_uitls.isAndroid) return (0, _android.getAndroidHeight)();else if (_uitls.isIos) return (0, _ios.getIosHeight)();
      return 0;
    }
  }]);
